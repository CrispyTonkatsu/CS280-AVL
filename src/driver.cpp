...
void simple_finds(CS280::AVLmap<int, int>& map, const std::vector<int>& data) {
...
// 100 times: insert between 20 and 200 and delete half of the number of
// inserted tree grows by average 90. max size 200*100=20000
void test17() {
  std::cout << "-------- " << __func__ << " --------\n";
